...
# change the name of "Points" to "points"
learning2014[,colnames(learning2014) == "Points"]
colnames(learning2014)["Points"]
...
# add a main title
p4 <- p3 + 
  ggtitle("the correlation between attitude and points")
...
p <- ggpairs(learning2014, mapping = aes(), lower = list(combo = wrap("facethist", bins = 10)))
?ggpairs
# draw the plot
p
...
#if our model outperforms random slope
anova(my_model, my_model1)
```
