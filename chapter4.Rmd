...
````
Scaling meand subtrating from the mean and dividing by the standdard deviation, after scaling, we can see that all the mean variable is 0
...
````
Fron the result given in the proportion of trace, the seperation achieved by the first discriminant function is 95.03% and the second is 3.89%.
There is a very large overlap between the low, med_low and med_high, high is well seperated fom the others and has somr med_high figures overlapping with it.
