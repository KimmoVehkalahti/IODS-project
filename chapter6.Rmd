...
### 2.1 Ajusting Baseline Approach
...
#### 2.1.3 Linear regression with baseline adjusted
...
### 2.2 Random intercept approach (section 1.5.2 is outside the requirement of assignment. Please skip this part and go to section 2 if you're not interested)
