...
#generate a codebook
# this string is copy from dataset introduction
...
The data set has 506 observations of 14 variables. Variable CHAS is a binary variable where 1 means the the place having tract that bounds river, and 0 means otherwise. It needs to be converted to a factor.
...
```{r fig.cap="Visualized relations of Boston dataset, message=FALSE, warning=FALSE, paged.print=FALSE}
library(GGally)
library(ggplot2)
